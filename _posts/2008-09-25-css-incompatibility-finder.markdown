...
author: aaron
comments: true
date: 2008-09-25 17:16:37+00:00
layout: post
slug: css-incompatibility-finder
...
<!-- more -->
    ...
    class cssCompat
    {
        ...
        /**
         * returns the content to parse through
         *
         * Either returns one result if its a css file
         * or if its mixed, goes through and looks for the "style" tag
         *
         * @return array
         */
