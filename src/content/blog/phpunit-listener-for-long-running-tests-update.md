...
tags:
  ...
  - phpunit
---
I wrote instructions in 2011 to [add a PHPUnit Listener to Watch for Long Running Tests](/2011/add-phpunit-listeners-to-watch-for-long-running-tests/) which seem to be a bit out of date now.  But, here's a quick refresher:
...
```php filename="tests/TestTimeThresholdListener.php"
<?php
/**
