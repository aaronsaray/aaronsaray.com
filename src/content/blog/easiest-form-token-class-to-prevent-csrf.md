...
tags:
  ...
  - security
---
So, if you're not familiar with CSRF, check out this blog post about [AJAX Security](/2007/ajax-security-research-and-findings-round-1/).  Some of the steps talking about Cross Site Request Forgeries will help you understand the problem.
...
```html filename="formWeWantToTokenize.php"
