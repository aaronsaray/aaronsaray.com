...
tags:
  ...
  - programming
---
I've written about [Custom PHP Exceptions](/2012/the-point-of-custom-exceptions/) before - as well as [using PHP Interfaces for code readability](/2022/add-interfaces-to-add-verbosity/). There's one coding pattern that I use pretty consistently that encompasses these concepts - a custom exception for code or functionality that is not yet written.
...
```php filename="app/Exceptions/NotImplementedException.php"
<?php
