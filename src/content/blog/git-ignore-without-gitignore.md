...
Normally, when you use a `.gitignore` file (not to be confused with [`.gitkeep` which is awful](/2021/better-alternative-to-gitkeep/)) you can tell git to ignore specific files or patterns. 
