...
I've written about this [before](/2011/add-phpunit-listeners-to-watch-for-long-running-tests/) and [revised it](/2017/phpunit-listener-for-long-running-tests-update/) as well, but with PHPUnit 9, we have new interfaces and classes that we need to create.  Let's get started.
