...
```php filename="app/Models/Dog.php"
<?php
...
```php filename="app\Http\Controllers\DogsController.php"
<?php
...
```php filename="app/Http/Requests/EditDogRequest.php"
<?php
...
```html filename="resources/dogs/edit.blade.php"
