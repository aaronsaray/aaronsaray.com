...
[I don't install Tinker on my production machine](/2021/do-not-use-tinker-in-production/), so in that same vein it feels like I shouldn't have a command to 'debug' config. But, if you're caching your config, and you've ever forgotten to update it correctly, you know the struggle.
